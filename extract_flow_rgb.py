...
root_path = "/data/xgg/dense_flow/UCF-101"
flow_path = "/data/xgg/dense_flow/UCF-101_Flow"
...
def extract_flow_rgb(root_dirs):
    ...
    for video_dir in video_dirs:
        ...
        for video in video_list:
            ...
            #cmd = './build/extract_gpu -f %s -x %s -y %s -i %s -b 20' % (tmp_file,x_dir,y_dir,i_dir)
            cmd = './build/extract_gpu -f={} -x={} -y={} -i={} -b=20 -t=1 -s=1 -o=dir'.format(tmp_file, x_dir, y_dir, i_dir)
