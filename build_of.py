...
def run_optical_flow(vid_item, dev_id=0):
    ...
    if os.path.exists(out_full_path):
        print(f'{out_full_path} has existed')
        return True
    try:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--src_dir", type = str, default = '/data/xgg/dense_flow/UCF-101/Driving')
    parser.add_argument("--out_dir", type = str, default = '/data/xgg/dense_flow/UCF-101_Flow/Driving')
